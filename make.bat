...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=baltimore-value-per-acre-analysis
SET SUPPORT_LIBRARY = baltimore_value_per_acre_analysis
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/baltimore-value-per-acre-analysis*.tar.bz2
