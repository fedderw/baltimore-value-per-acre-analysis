__title__ = 'baltimore-value-per-acre-analysis'
__version__ = '0.0.0'
__author__ = 'William Fedder and Anna Fedder'
__license__ = 'Apache 2.0'
__copyright__ = 'Copyright 2021 by William Fedder and Anna Fedder'
...
def example_function(in_path: Union[str, Path]) -> pd.DataFrame:
    ...
    .. code-block:: python
        ...
        from baltimore_value_per_acre_analysis import example_function
...
class ExampleObject(object):
    ...
    def example_static_function(in_path: Union[str, Path]) -> pd.DataFrame:
        ...
        .. code-block:: python
            ...
            from baltimore_value_per_acre_analysis import ExampleObject
    ...
    def example_class_method(cls):
        ...
        .. code-block:: python
            ...
            from from baltimore_value_per_acre_analysis import ExampleObject
